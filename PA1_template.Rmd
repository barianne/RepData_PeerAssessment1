...
By: Brigitte Malivert

March 15, 2015

<h2><strong> Loading and preprocessing the data </strong></h2>
...
<h2><strong> What is mean total number of steps taken per day?</strong></h2>
 
 For this part of the assignment, we can ignore the missing values in the dataset. 
 
 1. Make a histogram of the total number of steps taken each day.
 
 2. Cacluclate and report the mean and median total number of steps taken per day.
...
<strong> The mean and median total number of steps per day are 10766 and 10765 steps respectively. </strong>

<h2><strong> What is the average daily activity pattern?</strong></h2>
...
<strong> The 835<sup>th</sup> interval has maximum 206 (206.2) steps.</strong>

<h2><strong> Inputing missing values </strong></h2>
...
<strong> The total number of rows with NA's is 2304. </strong>
...
<strong> With data imputation, the means remain the same while there is slight change in median value.</strong>

<h2><strong> Are there differences in activity patterns between weekdays and weekends? </strong></h2>

The weekdays() function may be of some help here. I'll use the dataset with the filled-in missing values for this part.
